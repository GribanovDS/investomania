...
// Set the name of your SmartApp for activation
    ...
    let questions = [" Финансовая свобода — это… " ,
      ...
      " Выберите из предложенных вариантов то, что относится к активам " ,
      " Выберите из предложенных вариантов менее ликвидный актив. " ,
      " Выберите из предложенных вариантов менее ликвидный актив. " ,
      ...
      " Укажите категорию расходов, к которой можно отнести платеж по ипотеке. " ,
      " Что такое свободный денежный поток? " ,
      " Укажите способ увеличения свободного денежного потока. " ,
      ...
      " Эмитент — это … " ,
      " Что расскажете сотруднику банка? " ,
      ...
      " Акции какой компании, на ваш взгляд, выглядят наиболее рискованными? " ,
      " Что делать в первую очередь, если вы перевели деньги мошеннику (физическому лицу) в результате обмана? " ,
      " Чем занимались первые банкиры? " ,
      " Выберите основную функцию банка " ,
      ...
      " Кто такой дебитор? " ,
      " Кто такой кредитор? " ,
      " Как вы считаете, появление в экономике дешевых или даже бесплатных денег скорее вызовет… " ,
      ...
      " Мария зарабатывает 80 000 ₽, а ее муж Николай — 100 000 ₽. Они ведут совместный бюджет, их средние расходы составляют 90 000 ₽ в месяц. Посчитайте их норму сбережений. " ,
      ...
      " Вы приобретете мобильный телефон компании S в салоне связи P в кредит. Кому Вы должны будете выплачивать кредит: " ,
      ...
      " Если вы взяли кредит в банке и он обанкротился, то: " ,
      " Какой финансовый инструмент является самым безопасным? " ,
      " Вы хотите взять кредит, какой случай увеличит вероятность одобрения банка? " ,
      ...
      " Сколько попыток вы можете использовать при введении ПИН-кода до блокировки на банкомате? " ,
      " Вы хотите положить деньги в банк на два года. Банк по условиям договора добавляет к вашим средствам 8% в год. Сколько денег банк выплатит вам во второй год? " ,  
      " Вы хотите занять 50 000 рублей у друга. Он предлагает вам два варианта возврата средств. 1 вариант вернуть через год 75 000 рублей. 2 вариант вернуть через год 50 000 рублей плюс 20% от суммы долга. Какое предложение выгоднее для вас? " ,
    ...
    let answers = [[" Отсутствие кредитов " , " Наличие такого капитала, который позволит обеспечить пассивный доход, достаточный для желаемого образа жизни " , " Наличие такого капитала, который позволит покрывать обязательные расходы "],
      ...
      [" Не буду смотреть условия кредита, доверяя банку " , " Не буду смотреть, потому что это бесполезно " , " На полную стоимость кредита "],
      [" Не буду смотреть, потому что это бесполезно " , " На величину процентной ставки " , " Не буду смотреть условия кредита, доверяя банку "],
      ...
      [" Ваш кредит покроет агентство по страхованию вкладов " , " В судебном порядке можете потребовать, чтобы ваш кредитный договор признали недействительным " , " Должны выплачивать кредит, той организации, которую укажет администрация банка "],
      [" Акции " , " Облигации федерального займа " , " Фьючерсы "],
      [" У вас уже был кредит, но несмотря на просрочки вы выплатили его",  "У вас еще нет кредитной истории " , " У вас есть кредитная история, но у вас не было просрочек "],
      [" Автокредит " , " Потребительский кредит " , " Бизнес-кредит "],
      [" 13% " , " 20% " , " 10% "],
      ...
      [" У страховой меньше коэффициенты " , " В случае накопительной пенсии я сам вношу деньги на пенсионный счет " , " Страховая используется для оплаты пенсий нынешним пенсионерам "],
      ...
      [" 1,5 % в день " , " 15 % в месяц 2 " , " 50% в год "],
      [" Можете больше не выплачивать кредит " , " Ваш кредит покроет агентство по страхованию вкладов " , " Должны выплачивать кредит, той организации, которую укажет администрация банка "],
      [" Акции " , " Облигации федерального займа " , " Деньги, лежащие под подушкой "],
    ...
    const choose_questions = () =>  {
      if (started >= (questions.length / amount_of_questions -1)) {
    ...
    const third = () => {
      if (window.document.body.className == 'start') {
        ...
        document.getElementById('first').style.visibility= "hidden";
        document.getElementById('second').style.visibility = "hidden";
        document.getElementById('third').onclick = null;
        if (started == amount_of_questions) {
            assistant.sendData({
                  action: {
                      action_id: 'completed'
